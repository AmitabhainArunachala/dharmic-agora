...
| coupled element | evidence/path | coupling type | why it matters | recommended treatment (rename/extract to adapter/remove/keep with docs) | priority |
|---|---|---|---|---|---|
...
- Rename ports: `agora/gates.py`, `agora/gates_dgc.py`, `agora/node_governance.py`, `agora/app.py` UI dimensions/templates, federation if upgraded from shared secret to signed peer identity.
